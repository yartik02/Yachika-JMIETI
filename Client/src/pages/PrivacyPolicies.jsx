  ...
  return (
    <div id="PPs" className="PrivacyPolicies py-5 border position-relative">
      ...
      <div className="row mt-3 m-5">
          ...
          >
            ...
            >
              {sections.map((section) => (
                <a
                  key={section.id}
                  className="nav-link text-white m-0 p-3 text-truncate"
                  href={`#${section.id}`}
                >
                  {section.title}
                </a>
        ...
        {
          <div
            className="goToSectionDropdown text-start fw-light position-relative mb-3 p-0"
                  ...
                  >
                    ...
                    {section.title === selectedValue && (
                      <svg
                        ...
                        height="16"
                        fill="white"
                        className="bi bi-check ms-2 bg-white border border-white bg-opacity-10 rounded-circle"
                        viewBox="0 0 16 16"
                      >
        ...
        <div className="col-lg-9 text-start px-lg-5 mt-lg-0 mt-3">
          <div className="px-lg-4">
            ...
            <p
              className="fw-light mt-4 my-3"
              id="section-1"
              style={{ fontSize: "0.9rem" }}
            >
              Your trust and privacy are important to Yachika@JMIETI. This
              ...
              <div className="col-lg-10 col-xl-9 mt-4">
                ...
                <PolicySection title="1. Information We Collect">
                  ...
                  <div className="row mt-4" id="section-2">
                    ...
                    >
                      Name, Roll Number, Institutional Email ID, Department,
                      Password, etc.
                    </InfoCard>
                    <InfoCard
                    ...
                    >
                      Information in the complaint form, including description,
                    ...
                    >
                      Whether you choose to display or hide your identity in
                      certain complaints.
                    </InfoCard>
                    <InfoCard
                      icon="bi bi-laptop"
                      ...
                      variant="danger"
                      path={
                        "M13.5 3a.5.5 0 0 1 .5.5V11H2V3.5a.5.5 0 0 1 .5-.5zm-11-1A1.5 1.5 0 0 0 1 3.5V12h14V3.5A1.5 1.5 0 0 0 13.5 2zM0 12.5h16a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 12.5"
                      }
                    >
                ...
                >
                  ...
                  <div className="mt-4">
                    ...
                    <UsageStep number="05">
                      Ensure transparency, accountability, and security within
                      the institution.
                    </UsageStep>
                  </div>
                  <p className="fw-light border border-info bg-info bg-opacity-10 p-3 mt-4 rounded-4">
                    <svg
                      ...
                      width={25}
                      fill="#0dcaf0ff"
                      className="border border-3 border-info rounded-circle me-3"
                    >
                ...
                >
                  ...
                  >
                    When filing faculty or academic-related complaints, you can
                    choose to remain anonymous. In such cases, your personal
                    details are hidden even from administrators.
                  </PolicyAlert>
                  <PolicyAlert
                    icon="bi bi-building-check"
                    title="Identified Complaints"
                    variant="info"
                    path={
                  ...
                  >
                    For infrastructure or service-related issues, identity
                    information may be shared with the concerned department for
                    resolution purposes.
                  </PolicyAlert>
                </PolicySection>
                ...
                >
                  ...
                  >
                    No online platform is 100% secure. Users are encouraged to
                    use strong passwords and keep their login credentials
                    confidential.
                  </PolicyAlert>
                </PolicySection>
                ...
                <PolicySection id="section-9" title="8. Public Access and Use">
                  <p className="text-body-secondary">
                    ...
                    cannot access private complaint data.
                  </p>
                </PolicySection>
                ...
                <section className="mb-5">
                  <div className="cta-card text-center border-0 bg-body-tertiary rounded-4">
                    <div className="card-body p-4 p-md-5">
                      <h2 className="h4 fw-bold mb-3 text-gradient">
                        Contact Us
                      </h2>
                      ...
                      >
                        ...
                        <svg
                          ...
                          height="22"
                          fill="currentColor"
                          className="bi bi-envelope-at me-2 d-lg-flex d-md-flex d-none"
                          viewBox="0 0 16 16"
                        >
