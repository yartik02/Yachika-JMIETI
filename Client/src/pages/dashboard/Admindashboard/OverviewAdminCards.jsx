    ...
    },
    {
      ...
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width={60}
          fill="var(--stat-high-priority-icon)"
