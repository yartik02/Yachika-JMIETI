...
const floatingInfo = [
  ...
  },
  {
    ...
    color: "primary",
    position: { bottom: "-35px", right: "20px" },
    name: "bi bi-shield",
  },
];
function Main1() {
        ...
        <div className="row align-items-center mt-5 g-5 mb-5">
          <div className="col-lg-6 order-lg-1 order-1">
            <div className="d-flex flex-column mb-sm-5 mb-lg-0 h-100">
              <span className="badge bg-primary bg-opacity-10 fw-normal align-self-start mb-4 p-2 px-3 rounded-pill fs-6" style={{color:"#2648c2ff"}}>
                <svg
          ...
          <div className="col-lg-6 order-lg-2 order-2">
            <div className="position-relative d-inline-block">
              ...
              <img
                ...
                className="img-fluid rounded-4 border mx-auto shadow w-75"
              />
