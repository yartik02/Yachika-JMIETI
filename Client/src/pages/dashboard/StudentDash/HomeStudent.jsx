...
const HomeStudent = ({ student, studentComplaints }) => {
  ...
  return (
    <section>
      <div
        className="luminous-banner-wrapper rounded-4"
        style={{ width: "100%" }}
      >
        <div
          className="luminous-banner row rounded-4 text-center align-items-center p-lg-5 p-md-5 p-sm-0 mx-auto"
          ref={bannerRef}
        >
          <div className="banner-content col-12 order-sm-2 mb-3 order-lg-1 col-lg-6 text-lg-start text-sm-center">
            <h2 className="banner-title text-capitalize mb-3">
            ...
            <Link
              to="/complaintSubmission"
              className="banner-button p-2 px-3 rounded-3 btn-click-animation"
            >
      ...
      <section
        className="recentComplaints p-3 shadow-sm rounded-4"
        style={{
      ...
      >
        <div className="main">
          <div
            className="recentHead d-flex align-items-center fs-6"
          ...
          <p
            className="opacity-75 text-start mt-2"
          ...
          <div
            className="complaintSection d-flex flex-column justify-content-center"
          ...
          >
            {studentComplaints.length === 0 ? (
              <div className=" d-flex flex-column align-items-center justify-content-center">
                ...
                <Link
                  className="newComp p-2 px-3 rounded-3 btn-click-animation"
                  to="/complaintSubmission"
            ...
            {studentComplaints.length === 0 ? (
              ...
              <p
                ...
                style={{ fontSize: "0.8rem" }}
              >
                To view your all complaints please visit the  
                <strong> My Complaints</strong> tab.
              </p>
            )}
          </div>
        </div>
