  ...
  return (
    <section className="m-0 py-0">
      ...
      <div
        ...
        style={{ backgroundColor: "#f2f5feba" }}
      >
        {studentComplaints.length > 0 ? (
          ...
          <div className="noComplaints p-5 d-flex flex-column align-items-center">
            ...
            <p
              className="text-center fw-normal my-2"
              style={{ color: "#585858ff" }}
            >
              You haven't submitted any complaints yet.
            </p>
            <button
              className="px-3 py-2 rounded firstCompBtn d-flex align-items-center mx-auto mt-2"
        ...
        {studentComplaints.length === 0 ? (
          ...
          <p
            className="m-0 mt-auto mb-0 text-muted opacity-75 text-center"
