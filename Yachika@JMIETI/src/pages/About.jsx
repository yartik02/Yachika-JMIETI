...
const About = () => {
  return (
    <div className="aboutMain" style={{width:"100vw"}}>
      <div className="my-5 mx-auto" style={{width:"97.5vw"}}>
        <span className="badge bg-primary bg-opacity-10 fw-normal align-self-start mb-5 p-2 px-3 rounded-pill fs-6" style={{color:"#2648c2ff"}}>
          {/* <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-book-open h-4 w-4 me-1" aria-hidden="true">
